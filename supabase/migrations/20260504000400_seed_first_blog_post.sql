...
VALUES (
  'Cara Memilih Kidswear Premium yang Tetap Nyaman untuk Si Kecil',
  'cara-memilih-kidswear-premium-yang-nyaman',
  ...
  'Memilih baju anak sering terlihat sederhana, sampai kita ingat bahwa si kecil bergerak hampir sepanjang hari. Outfit yang cantik perlu tetap ringan, lembut, dan membuat mereka bebas bereksplorasi.
...
Pada akhirnya, outfit terbaik adalah yang membuat si kecil terlihat manis sekaligus merasa bebas menjadi dirinya sendiri. Karena momen kecil mereka layak dirayakan dengan pilihan yang nyaman, berkualitas, dan penuh cinta.',
  '/blog/premium-kidswear-little-moments.png',
  true,
  'Cara Memilih Kidswear Premium yang Nyaman | Hanrose Atelier',
